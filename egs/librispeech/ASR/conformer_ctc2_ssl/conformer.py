...
from subsampling import Conv2dSubsampling2x
...
class Conformer(Transformer):
    ...
    Args:
        ...
        feature_projection_out_dim (int): Output dimension of the SSL feature projection layer.
    ...
    def __init__(
        ...
        self.proj_ssl = SSLFeatureProjection(
                in_features=num_features,
                out_features=feature_projection_dim,
        )
        
        self.encoder_embed = Conv2dSubsampling2x(feature_projection_dim, d_model)
